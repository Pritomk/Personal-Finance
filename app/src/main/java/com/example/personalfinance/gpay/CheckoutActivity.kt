package com.example.personalfinance.gpay
...
import com.example.personalfinance.databinding.ActivityCheckoutBinding
import com.example.personalfinance.gpay.viewmodel.CheckoutViewModel
...
class CheckoutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layoutBinding.detailPrice.text = price.toString()
        layoutBinding.detailDescription.text = name
